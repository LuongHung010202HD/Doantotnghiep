<div>
  ...
  border-width: 5px;">
   ...
   Ngày khởi hành :<b> {{ \Carbon\Carbon::parse($tour->t_start_date)->format('d/m/Y') }}</b> <p>
   Điểm xuất phát :<b> {{ $tour->t_starting_gate }} </b> <br>
 ...
 <b style="color:red">Nếu có thắc mắc, quý khách vui lòng liên hệ luonghung@gmail.com</b><br>
</div>
